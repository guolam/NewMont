...
Route::middleware('auth')->group(function () {
    ...
    // Route::put('/groupcontent/update/{id}', [GroupContentController::class, 'update'])->name('groupcontent.update');
    Route::put('/groupcontent/{group_id}/update/{id}', [GroupContentController::class, 'update'])->name('groupcontent.update');
    // Route::put('/groupcontent/{id}/{group_id}', [GroupContentController::class, 'update'])->name('groupcontent.update');
